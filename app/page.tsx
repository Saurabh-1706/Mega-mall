        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <HeroVideo
              ...
              poster="/images/wem/wem_night_hero.jpg"
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-12 gap-8">
              ...
              <div className="col-span-12 lg:col-span-5 relative aspect-[4/5] bg-surface-container overflow-hidden">
                <Image
                  alt="WEM Architecture"
                  className="object-cover grayscale opacity-80 hover:grayscale-0 hover:scale-110 transition-all duration-1000"
                  src="/images/wem/wem_interior.jpg"
                  fill
        ...
        <section className="py-32 px-12 bg-surface-container-low">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-1 px-4">
            ...
            <div className="group relative aspect-[3/4] overflow-hidden bg-black">
              <Image alt="Luxury District" className="object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-700" src="/images/wem/wem_europa.jpg" fill sizes="(max-width: 768px) 100vw, 33vw" />
            ...
            {/* Bourbon Street */}
            <div className="group relative aspect-[3/4] overflow-hidden bg-black">
              <Image alt="Dining District" className="object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-700" src="/images/wem/wem_ice_palace.jpg" fill sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-t from-black/80 via-transparent to-transparent">
            ...
            {/* Galaxyland */}
            <div className="group relative aspect-[3/4] overflow-hidden bg-black">
              <Image alt="Galaxyland District" className="object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-700" src="/images/wem/wem_galaxyland.jpg" fill sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-t from-black/80 via-transparent to-transparent">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
          <div className="col-span-2">
            ...
            <div className="flex space-x-6">
              ...
              <a className="text-white/40 hover:text-primary transition-colors" href="#"><span className="material-symbols-outlined">share</span></a>
