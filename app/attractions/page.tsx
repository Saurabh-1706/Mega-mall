...
<h1 className="font-headline text-6xl md:text-[7rem] leading-[0.9] text-white font-bold tracking-tighter mb-8 italic">
...
<section className="py-20 md:py-32 px-6 md:px-20 grid grid-cols-1 lg:grid-cols-12 gap-12 bg-surface-container-low">
...
<div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-px bg-outline-variant/10">
...
<div className="bg-surface p-8 md:p-12 flex flex-col justify-center">
<span className="font-headline text-5xl md:text-6xl text-primary mb-2">68%</span>
...
<div className="px-6 md:px-20 mb-16 md:mb-24 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
<div>
...
<section className="relative py-24 md:py-40 px-6 md:px-20 overflow-hidden">
<div className="absolute inset-0 bg-surface-container-highest opacity-40"></div>
<div className="absolute top-0 right-0 w-1/2 h-full bg-primary/5 skew-x-12 translate-x-32 hidden md:block"></div>
<div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
<div className="md:col-span-7">
<h2 className="font-headline text-5xl lg:text-7xl text-white mb-8 tracking-tighter italic">Position Your Brand <br/>At the Heart of the Show.</h2>
...
<div className="bg-surface p-8 md:p-12 shadow-2xl relative border-b-4 border-primary">
...
<footer className="py-12 md:py-20 px-6 md:px-20 bg-surface-container-lowest flex flex-col md:flex-row justify-between items-start md:items-center border-t border-outline-variant/10 gap-8">
